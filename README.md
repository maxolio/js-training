...
разбирать задачу на атомы, понимать работу движка JS «под капотом» (Call Stack, Memory Heap, Lexical
...
|:---------|:------------------------------------------------------------|:---------:|
| **10**   | Объекты: создание, свойства, вычисляемые ключи (Task 10.1)  |  ✅ done   |
| **11**   | Ссылочный тип, клонирование объектов (Task 11.1)            |  ✅ done   |
| **12**   | Ключевое слово `this`, методы, потеря контекста (Task 12.1) | ⏳ pending |
| **BOSS** | Движок Корзины интернет-магазина (Shop Engine UI)           | ⏳ pending |
...
│       ├── style.css
│       └── app.js
│──sprint_03_objects_this/
│   └── 01_warmup/
│       ├── task_10_1_dynamic_profile.js    # Objects, computed keys, optional chaining ?.
│       └── task_11_1_config_merger.js      # Shallow copy vs Deep copy (structuredClone)
